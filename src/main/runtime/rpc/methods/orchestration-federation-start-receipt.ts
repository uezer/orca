...
export function failFederatedAttachmentWithReceipt(args: {
  ...
  return {
    ...
    worktreeId: attachment.worktree_id ?? undefined,
    terminalHandle: attachment.terminal_handle ?? undefined,
    paneKey: attachment.pane_key ?? undefined,
    processIncarnation: attachment.process_incarnation ?? undefined,
